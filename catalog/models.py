...
class Book(models.Model):
    ...
    image = models.ImageField(upload_to='books/', default='books/temp.jpg', null=True)
    ...
    def display_genre(self):    # pragma: no cover
...
class Author(models.Model):
    ...
    image = models.ImageField(upload_to="authors", default="authors/temp.jpg")
